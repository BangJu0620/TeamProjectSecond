    ...
    public class EventManager
    {
        ...
        public static int? CheckInput()  // 선택을 입력받는 함수
        {
            ...
            while (true)
            {
                ...
                else if (isNumber && number >0)                             return number;
                else if (!isNumber && ((input == "a") || (input == "A")))   return -1;
                else if (!isNumber && ((input == "d") || (input == "D")))   return -2;
                else                                                        return -3;
            }
        }
        ...
        public static void Clear() // 화면 위 아래의 주사위를 그리는 함수
        {
            string[] repeated = { "⚀", "⚁", "⚂", "⚃", "⚄", "⚅" };
