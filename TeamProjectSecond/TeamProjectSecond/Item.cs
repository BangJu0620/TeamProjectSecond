...
namespace TeamProjectSecond
{
    ...
    public class Item
    {
        ...
        static Item()
        {
            ...
            instance.Add(new ItemData(303, "경찰 배지", ItemType.Accessory, 0, 0, 0, 50, 1, 3, 0, "MaxMP+50, 추가데미지+3", "이거까지 내기에 걸어?", 800, false, false, null, false,3));
            instance.Add(new ItemData(304, "행운의 칩", ItemType.Accessory, 0, 0, 0, 0, 1, 0, 1, "리롤+1", "일이 잘 풀릴 것 같다.", 800, false, false, null, false,2));
            instance.Add(new ItemData(305, "딜러의 카드덱", ItemType.Accessory, 0, 0, 0, 0, 1.04f, 0, 0, "데미지+4%", "딜러의 카드덱.", 800, false, false, null, false));
            instance.Add(new ItemData(306, "결혼 반지", ItemType.Accessory, 0, 0, 50, 0, 1, -6, 0, "MaxHP+50, 추가데미지-6", "누군가 내기로 건 반지.", 800, false, false, null, false,1));
            instance.Add(new ItemData(307, "무전기 이어폰", ItemType.Accessory, 0, 0, 0, 0, 1, 5, 0, "추가데미지+5", "도둑이 훔쳐간 이어폰.", 800, false, false, null, false,2));
            instance.Add(new ItemData(308, "마법사의 모자", ItemType.Accessory, 0, 0, 0, 30, 1, 5, 0, "MaxMP+30, 추가데미지+5", "마술 하나 보여줄까?", 800, false, false, null, false,3));
            instance.Add(new ItemData(309, "카지노 칩", ItemType.Accessory, 0, 0, 0, 0, 1, 0, 1, "리롤+1", "현금 대신 사용하는 칩.", 800, false, false, null, false,2));
            instance.Add(new ItemData(310, "괴도의 가면", ItemType.Accessory, 0, 3, 0, 20, 1, 0, 0, "속도+3, MaxMP+20", "단골 손님의 가면.", 800, false, false, null, false,3));
            instance.Add(new ItemData(311, "선글라스", ItemType.Accessory, 0, 0, 0, 0, 1, 7, 0, "추가데미지+7", "카리스마를 올려준다.", 800, false, false, null, false,2));
            instance.Add(new ItemData(312, "머니건", ItemType.Accessory, 0, 0, 0, 0, 1.02f, 4, 0, "데미지+2%, 추가데미지+4", "가폐를 날리는 장난감.", 800, false, false, null, false,2));
