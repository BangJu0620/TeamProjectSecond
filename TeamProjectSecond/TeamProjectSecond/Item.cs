...
namespace TeamProjectSecond
{
    ...
    public class ItemData
    {
        ...
        public ItemData(string name, ItemType type, int atk, int def, string description, int price, bool owned, bool equipped, int speed = 0, int maxHP = 0, int maxMP = 0, bool isShopItem = true)
        {
            ItemName = name;
            ItemType = type;
            ItemAttackPoint = atk;
