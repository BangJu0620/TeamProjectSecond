    ...
    public static Dictionary<int, List<Monster>> MonsterDictionary = new Dictionary<int, List<Monster>>()
    {
        ...
        },
        {
            2, new List<Monster>()
            {
                ...
                new Monster(2, 3, "주사위 거북이", 0, 5, 5, 15, " '단단해 보이는군...' ", "\" 흐에에.. \"")
            }
        },
        {
            3, new List<Monster>()
        ...
        },
        {
            4, new List<Monster>()
            {
                new Monster(4, 0, "주사위 곰", 7, 6, 8, 42, "\" 우루룽~ \"", "\" 고옴... \""),
                new Monster(4, 1, "도박 경찰", 7, 5, 12, 39, "\" 녀석을 도박으로 구속해라! \"", "\" 내가 도박에서 패배하다니... \""),
                new Monster(4, 2, "주사위 매니저님", 7, 4, 14, 32, "\" 아,아,잘들리시나요? \"", "\" 크아아아악! \"")
            }
        },
        {
            5, new List<Monster>()
            {
                new Monster(5, 0, "주사위 늑대맨", 10, 8, 16, 60, "\" 아우우우! \"", "\" 아이구 아파라... \""),
                new Monster(5, 1, "주사위 박쥐떼", 10, 4, 22, 45, "\" 푸드드득! \"", "\" 푸우우... \""),
                new Monster(5, 2, "주사위 사자", 10, 7, 14, 55, "\" 크르릉!! \"", "\" 으르릉... \"")
            }
        },
        {
            7, new List<Monster>()
            {
                new Monster(7, 0, "약한보스몬스터", 5, 12, 15, 180, "\" 나는보스몹이당 \"", "\" 치욕스럽다~ \"")
            }
        },
        {
            10, new List<Monster>()
