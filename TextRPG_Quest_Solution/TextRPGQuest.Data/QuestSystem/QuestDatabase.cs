...
namespace TextRPGQuest.QuestSystem
{
    ...
    public static class QuestDatabase
    {
        ...
        {
            AllQuests.Add(new Quest(IDManager.GetNextID(), "주사위 슬라임 5마리 처치", "주사위 슬라임을 5마리 잡으세요", QuestCategory.KillMonster, 5, 100, 50));
            AllQuests.Add(new Quest(IDManager.GetNextID(), "쉬움 던전 클리어", "쉬움 던전을 클리어하세요", QuestCategory.ClearDungeon, 1, 300, 150));
            AllQuests.Add(new Quest(IDManager.GetNextID(), "MP 포션 3개 수집", "MP 포션을 3개 모으세요", QuestCategory.Collect, 3, 100, 20));
        }
